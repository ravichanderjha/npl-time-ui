...
?>
							...
							?>
								...
								var chart = new google.visualization.GeoChart(document.getElementById('ntp_geo'));

								chart.draw(data, options);
							      }
							    </script>
							    <div id="ntp_geo" style="width:100%;"></div>
								...
								?>
								    ...
								    <div id="ntp_geo_pi" style="position:absolute;width:25%;bottom:1px;"></div>
